...
//	int Sourcelength = 0;
//	ImgData SourceData;
//	SourceData.readImage(InSourceImgName, &Sourcelength);
//	std::cout << Sourcelength;
//	//保存输入原始图像文件名
//	char InTemplateImgName[10];
//	std::cout << "Enter template Image name:";
//	std::cin >> InTemplateImgName;
//	int Templatelength = 0;
//	ImgData TemplateData;
//	TemplateData.readImage(InTemplateImgName, &Templatelength);
//
//
//
//	return;
